...
projects:
  [
    ...
    },
    {
      ...
      keywords: ["Swift", "UIKit", "SwiftUI", "TCA", "XCTest", "Combine", "SPM", "GraphQL", "Apollo", "Realm", "RevenueCat", "Superwall"],
    },
    {
      title: Scan Pay Go,
      abstract: "Shopping made simpler! myWaitrose members can use ScanPayGo within Waitrose & Partners' app. It’s simple and one of the fastest ways to shop in store. Just scan and pack as you shop, using your phone or one of the handsets and then pay at the Self Checkout Area.",
      website: "https://apps.apple.com/gb/app/waitrose-partners/id1346064128",
      keywords: ["Swift", "UIKit", "SwiftUI", "MVVM(-C)", "TCA", "XCTest","ReactiveCocoa/ReactiveSwift", "CocoaPods", "SPM", "REST", "GraphQL", "Apollo", "Alicerce"],
    },
    {
      title: Porto Campus Studios,
      abstract: "A website to showcase housing for students in Porto, Portugal.",
      github: https://github.com/literallysofia/portocampustudios,
      website: https://portocampustudios.com,
