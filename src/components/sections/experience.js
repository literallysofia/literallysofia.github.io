            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  <ul>
                    <li>
                      Prototype design and web development, working mostly for
                      the design and marketing department.
                    </li>
                  </ul>
                </Card.Text>
              </Card.Body>
            ...
            <Card>
              ...
              <Card.Body>
                <Card.Title>
                  ...
                  <a href="http://portocampustudios.com">
                ...
                <Card.Text>
                  <ul>
                    <li>
                      ...
                      developing a design to advertise its products and
                      services.
                    </li>
                ...
                <Card.Text>
                  <ul>
                    <li>
                      ...
                      cycle of basic education and secondary education
                      (typically up to the 11th year).
                    </li>
                    <li>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  <ul>
                    <li>
                      I was invited by a teacher to present Sweven, a project
                      for the Database and Web Applications Laboratory (LBAW)
                      class of the Master in Informatics and Computer
                      Engineering (MIEIC). At the end of each session, I spoke
                      about my experience in college and cleared any doubts
                ...
                <Card.Text>
                  <ul>
                    <li>
                      ...
                      Computing Engineering. At "Mostra" high school students
                      can talk to university teachers, researchers and students
                      so that they get to know what the University of Porto has
                      to offer. It aims to contribute to a more informed future
                      vocational decision.
                    </li>
                  </ul>
                </Card.Text>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  <ul>
                    <li>
                      Active participation in the Informatics Club of the
                      Faculty of Engineering (Academic Organization).
                    </li>
                  </ul>
                </Card.Text>
              </Card.Body>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  <ul>
                    <li>
                      Participation in the organization of Semana de
                      Informática, a yearly tech conference that takes place at
                      the Faculty of Engineering at University of Porto.
                    </li>
                  </ul>
                </Card.Text>
              </Card.Body>
